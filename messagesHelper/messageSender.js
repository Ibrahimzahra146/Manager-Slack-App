        ...
        function (callback) {
            ...
            if (managerEmail != email) {
                env.mRequests.getSlackRecord(managerEmail, function (error, response, body) {
                    ...
                    var message = "Hi, the approver " + email + " has submitted a vacation for " + employeeEmail + "( from " + fromDate + " to " + toDate + " )"
                    env.managerBot.startConversation(slack_Message, function (err, convo) {
                        if (!err) {
                            ...
                            env.managerBot.reply(slack_Message, obj1, function (err, response) {
                            });
