                    ...
                    if (!error && response.statusCode === 200) {
                        async.whilst(
                            ...
                            function (callback) {
                                ...
                                var wordFromDate = new Date(body[i].fromDate)
                                var wordTodate = new Date(body[i].toDate)
                                var arr = wordFromDate.toString().split(" ")
                                wordFromDate = arr[0] + ", " + arr[1] + " " + arr[2] + " " + arr[3] + " " + (arr[4] + 3)
                                arr = wordTodate.toString().split(" ")
                                wordTodate = arr[0] + ", " + arr[1] + " " + arr[2] + " " + arr[3] + " " + +(arr[4] + 3)
